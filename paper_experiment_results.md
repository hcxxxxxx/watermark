...
AudioSeal 和 WavMark 均作为波形后处理方法评测：先用对应声码器生成无水印 benchmark audio，再在波形上嵌入 16 bit payload，然后施加同一组攻击。表中 `ACC` 是 payload 比特准确率，`VR` 是按各自检测逻辑和 `bit_acc_threshold=0.75` 得到的验证率。AudioSeal 的 `VR` 还要求 detector score 大于 0.5；因此噪声攻击下可能出现 `ACC` 不低但 `VR=0` 的情况。
...
| HiFi-GAN | WavMark | 16 | 4.2975 | 1.0000 / 1.000 | 0.0440 / 0.042 | 0.0000 / 0.000 | 0.0011 / 0.000 | 加性噪声下基本失效 |
| DiffWave | AudioSeal | 16 | 4.4225 | 1.0000 / 1.000 | 0.9659 / 0.138 | 0.7544 / 0.000 | 0.6175 / 0.000 | DiffWave 下 noise20 验证率更低 |
| DiffWave | WavMark | 16 | 4.0204 | 1.0000 / 1.000 | 0.0046 / 0.004 | 0.0000 / 0.000 | 0.0000 / 0.000 | 加性噪声下基本失效 |
...
| 攻击 | HiFi-GAN ACC | HiFi-GAN VR | HiFi-GAN PESQ | DiffWave ACC | DiffWave VR | DiffWave PESQ |
|---|---:|---:|---:|---:|---:|---:|
| none | 1.0000 | 1.000 | 4.2975 | 1.0000 | 1.000 | 4.0204 |
| mp3 | 1.0000 | 1.000 | 4.0430 | 1.0000 | 1.000 | 3.7873 |
| aac | 1.0000 | 1.000 | 4.2366 | 1.0000 | 1.000 | 3.9731 |
| scale | 1.0000 | 1.000 | 4.2975 | 1.0000 | 1.000 | 4.0204 |
| rs16 | 1.0000 | 1.000 | 4.2975 | 1.0000 | 1.000 | 4.0204 |
| bandpass | 1.0000 | 1.000 | 4.2896 | 1.0000 | 1.000 | 4.0242 |
| lowpass | 1.0000 | 1.000 | 3.9818 | 1.0000 | 1.000 | 3.7299 |
| noise20 | 0.0440 | 0.042 | 1.4674 | 0.0046 | 0.004 | 1.3804 |
| noise10 | 0.0000 | 0.000 | 1.0698 | 0.0000 | 0.000 | 1.0540 |
| noise5 | 0.0011 | 0.000 | 1.0337 | 0.0000 | 0.000 | 1.0293 |
| echo | 0.9988 | 1.000 | 1.8560 | 0.9998 | 1.000 | 1.6630 |

结论：AudioSeal 和 WavMark 在压缩、缩放、重采样、滤波、回声等非噪声攻击下非常强，同时水印引入的干净音质损失也很小。但在加性噪声攻击下，尤其 `noise10/noise5`，二者作为波形后处理 watermark 的验证率明显低于 RelMel。与它们对比时需要强调 payload 长度不同：AudioSeal/WavMark 为 16 bit，RelMel/MelShield 主实验为 32 bit。
